...
export const DeepDiveShowcases: React.FC = () => {
  ...
  return (
    <section className={`py-20 lg:py-28 bg-[#090e1a] text-white relative overflow-hidden ${isAr ? "font-arabic" : ""}`} dir={isAr ? "rtl" : "ltr"}>
      {/* Refined subtle structural grid lines & ambient lighting */}
      ...
      <div className="absolute -top-40 right-1/4 w-[600px] h-[600px] bg-emerald-500/5 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-emerald-500/10 text-emerald-400 border border-emerald-500/25 text-xs font-semibold uppercase tracking-wider mb-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center mb-24">
          <div className="lg:col-span-6 space-y-4">
            <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-md bg-emerald-500/15 text-emerald-400 text-xs font-semibold">
            ...
            <div className="pt-3">
              <Link
                href="/signup"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white font-bold text-xs sm:text-sm transition-all shadow-lg shadow-emerald-600/20"
              >
          ...
          <div className="lg:col-span-6 bg-[#0e1626] p-6 rounded-3xl border border-slate-800 shadow-2xl relative">
            <div className="space-y-3.5">
              <div className="flex items-center justify-between pb-2.5 border-b border-slate-800 text-xs">
                ...
                <span className="text-emerald-400 font-mono font-semibold">{isAr ? "السلة: 249 ر.س" : "Cart: 249 SAR"}</span>
              </div>

              <div className="bg-[#131d31] p-4 rounded-2xl border border-slate-700/60 space-y-3">
                <div className="flex items-center gap-3">
                  <div className="w-11 h-11 rounded-xl bg-emerald-950/80 border border-emerald-500/30 flex items-center justify-center text-emerald-400 font-bold text-base">
                    🛍️
                  </div>
                  <div>
              ...
              <div className="p-3 rounded-xl bg-slate-900/90 border border-slate-800 flex items-center justify-between text-xs text-emerald-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center">
          <div className="lg:col-span-6 order-2 lg:order-1 bg-[#0e1626] p-6 rounded-3xl border border-slate-800 shadow-2xl">
            <div className="space-y-3.5">
              <div className="flex items-center justify-between pb-2.5 border-b border-slate-800 text-xs">
                <span className="text-slate-400">{isAr ? "استفسار صوتي من العميل" : "Multilingual Voice Query"}</span>
                <span className="text-indigo-400 font-mono text-[11px]">0.4s Voice SLA</span>
              </div>

              <div className="bg-[#131d31] p-4 rounded-2xl border border-slate-700/60 space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-semibold text-indigo-300 flex items-center gap-1.5">
                    <Volume2 className="w-3.5 h-3.5 text-indigo-400" /> {isAr ? "رسالة صوتية مولدة بالذكاء الاصطناعي" : "AI Synthesized Voice Note"}
                  </span>
                  <button
                    type="button"
                    onClick={() => setIsPlayingAudio(!isPlayingAudio)}
                    className="w-7 h-7 rounded-full bg-indigo-600 hover:bg-indigo-500 text-white flex items-center justify-center transition-transform active:scale-95 cursor-pointer"
                  >
                    {isPlayingAudio ? <Pause className="w-3.5 h-3.5" /> : <Play className="w-3.5 h-3.5 ml-0.5" />}
                  </button>
                </div>

                <div className="flex items-center gap-1.5 h-8 px-2.5 bg-slate-950/80 rounded-xl">
              ...
              <div className="p-3 rounded-xl bg-slate-900/90 border border-slate-800 flex items-center justify-between text-xs text-slate-400">
                ...
                <span className="text-emerald-300 font-semibold">{isAr ? "اللهجة السعودية وأكثر من 40 لغة" : "40+ Dialects & Languages"}</span>
              </div>
            </div>
          </div>

          <div className="lg:col-span-6 order-1 lg:order-2 space-y-4">
            <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-md bg-indigo-500/15 text-indigo-400 text-xs font-semibold">
            ...
            <div className="pt-3">
              <Link
                href="/signup"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-indigo-600 to-emerald-600 hover:from-indigo-500 hover:to-emerald-500 text-white font-bold text-xs sm:text-sm transition-all shadow-lg shadow-indigo-600/20"
              >

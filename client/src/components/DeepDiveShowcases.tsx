...
export const DeepDiveShowcases: React.FC = () => {
  ...
  return (
    <section className="py-24 lg:py-32 bg-slate-900 text-white relative overflow-hidden">
      {/* Glow Effects */}
      <div className="absolute top-1/4 -left-40 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-purple-500/20 text-purple-300 border border-purple-500/30 text-xs font-semibold uppercase tracking-wider mb-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center mb-28">
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="pt-4">
              <Link
                href="/signup"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-purple-600 hover:bg-purple-500 text-white font-semibold text-sm transition-all shadow-md shadow-purple-600/20"
              >
          ...
          <div className="lg:col-span-6 bg-slate-950 p-6 sm:p-8 rounded-3xl border border-slate-800 shadow-2xl relative">
            <div className="space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-slate-800 text-xs">
                ...
                <span className="text-purple-400 font-mono">Cart Value: ₹2,499</span>
              </div>

              <div className="bg-slate-900 p-4 rounded-2xl border border-slate-800 space-y-3">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-xl bg-purple-950 flex items-center justify-center text-purple-400 font-bold">
                    🛍️
                  </div>
                  <div>
                    <div className="text-sm font-bold text-white">Silk Embroidered Kurti Set</div>
                    <div className="text-xs text-slate-400">Size: M · Color: Royal Purple</div>
                  </div>
                </div>

                <div className="p-2.5 rounded-lg bg-purple-950/80 border border-purple-500/30 flex items-center justify-between text-xs">
                  <span className="text-purple-200">✓ UPI Instant Pay Confirmed</span>
                  <span className="font-mono text-purple-400 font-bold">₹2,499.00</span>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
              ...
              <div className="bg-slate-900 p-4 rounded-2xl border border-slate-800 space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  {["Malayalam (മലയാളം)", "Manglish", "Hindi / Hinglish", "Arabic (العربية)", "English"].map((lang, i) => (
                    <span key={i} className="text-xs font-medium px-2.5 py-1 rounded-lg bg-slate-800 text-purple-300 border border-slate-700">
                      {lang}
                    </span>
                  ))}
                </div>

                <div className="mt-4 p-3 rounded-xl bg-purple-950/70 border border-purple-500/30 flex items-center gap-3">
                  <button
                    onClick={() => setIsPlayingAudio(!isPlayingAudio)}
                    className="w-9 h-9 rounded-full bg-purple-500 text-white flex items-center justify-center flex-shrink-0"
                  >
                    {isPlayingAudio ? <Pause className="w-4 h-4 fill-white" /> : <Play className="w-4 h-4 fill-white ml-0.5" />}
                  </button>
                  <div className="flex-1">
                    <div className="text-[11px] font-bold text-purple-300">Live Malayalam Voice Note Sample</div>
          ...
          <div className="lg:col-span-6 order-1 lg:order-2 space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-indigo-500/20 text-indigo-400 text-xs font-semibold">
            ...
            <div className="pt-4">
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-sm transition-all shadow-md shadow-indigo-600/20"
              >

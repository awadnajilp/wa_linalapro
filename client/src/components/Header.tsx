    ...
    >
      <div className="max-w-7xl mx-auto p-5 sm:p-6 md:p-8">
        ...
        <div className="mt-8 pt-6 border-t border-gray-100/80 dark:border-gray-700/50 hidden md:block">
          <div className="bg-gradient-to-r from-emerald-50/80 to-indigo-50/80 dark:from-emerald-900/15 dark:to-indigo-900/15 rounded-2xl p-6 border border-emerald-100/50 dark:border-emerald-800/30">

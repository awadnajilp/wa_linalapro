...
const TESTIMONIALS: Testimonial[] = [
  ...
  },
  {
    ...
    company: "CarePlus Wellness",
    location: "Zurich, Switzerland",
    rating: 5,
    text: "Multilingual voice note understanding across 40+ languages is a game changer. Customers get instant assistance in their preferred native language.",
